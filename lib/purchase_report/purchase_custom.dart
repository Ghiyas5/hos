...
void main() => runApp(MaterialApp(
  home: PurchaseCustomReport(),
));

class PurchaseCustomReport extends StatefulWidget {
  @override
  _PurchaseCustomReportState createState() => _PurchaseCustomReportState();
}

class _PurchaseCustomReportState extends State<PurchaseCustomReport> {
        ...
        child: Form(
          ...
          child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 20,),
                SizedBox(child: Text(
                  'Supplier', style: TextStyle(color: Colors.green),),),
                SearchableDropdown(
