...
import 'package:hos/purchase_report/purchase_custom.dart';
import 'package:hos/purchase_report/purchase_quick.dart';

void main() => runApp(MaterialApp(
  home: PurchaseSalesReport(),
));

class PurchaseSalesReport extends StatefulWidget {
  @override
  _PurchaseSalesReportState createState() => _PurchaseSalesReportState();
}

class _PurchaseSalesReportState extends State<PurchaseSalesReport> {
  int selected = 0;
  @override
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: selected == 0?PurchaseQuickReport():PurchaseCustomReport(),
                    ),
                  ],
                )
